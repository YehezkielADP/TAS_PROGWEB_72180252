        ...
        <div class="col-md-4">
          <div class="card">
            ...
            <?php if(isset($_SESSION['mhs'])){?>
                ...
                <form action="function/function_pasw_mahasiswa.php" method="post">
                
              <div class="form-group">
                  <input type="text" disabled="disabled" name="nim" class="form-control" value="<?php echo $data['nim'];?>">
                </div>
                <div class="form-group">
                  <input type="text" name="pasw" class="form-control" placeholder="input pasword baru">
                </div>
                ...
                <div class="form-group">
                  <input type="submit" name="submit" value="edit pasword" class="btn btn-primary btn-block">
              ...
              <?php if(isset($_SESSION['dosen'])){?>
                ...
                <?php while($data = mysqli_fetch_array($select)){?>
                <form action="function/function_pasw_dosen.php" method="post">
