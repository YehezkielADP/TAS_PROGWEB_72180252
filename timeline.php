                    ...
                    <div class="col-lg-9 col-sm-8 col-md-8 col-xs-12">
                        <div class="d-md-flex">
                            <ol class="breadcrumb ms-auto">
                                <li><a href="home.php" class="fw-normal">Data Timeline</a></li>
                            </ol>
                            
                        </div>
                    </div>
                    <?php $select = mysqli_query($conn, "SELECT * FROM timeline ORDER BY id_timeline ASC"); ?>
                    ...
                    <div class="col-md-12 col-lg-12 col-sm-12">
                        <div class="white-box">
                            <div class="d-md-flex mb-3">
                                <h3 class="box-title mb-0">Daftar Timeline</h3>
                            ...
                            <a href="form_input_timeline.php"><button class="btn btn-primary btn-block">Tambah Data</button></a>
                            <?php } ?>
                                ...
                                <table class="table no-wrap">
                                    <thead>
                                        ...
                                        <tr>
                                            ...
                                            <th class="border-top-0">status timeline</th>
                                    ...
                                    <?php while($data = mysqli_fetch_array($select)){?>
                                        <tr>
                                            ...
                                            <td class="txt-oflo"><?php echo $data['tanggal_selesai'];?></td>
                                            <td><?php echo $data['status'];?> </td>
                                            
                                            
                                            <?php if(isset($_SESSION['koor'])){?>
                                            <td><a href="form_edit_timeline.php?id=<?php echo $data['id_timeline'];?>"><span class="btn btn-primary btn-block">edit</span></a> 
                                            <a href="function/function_delete_timeline.php?id=<?php echo $data['id_timeline'];?>"><span class="btn btn-primary btn-block">hapus</span></a></td>
                                            <?php } ?>
                                            <?php if(isset($_SESSION['mhs'])){?>
