...
<body>
    <div class="container">
      <div class="row justify-content-center mt-5">
        <div class="col-md-4">
          <div class="card">
            <div class="card-header bg-transparent mb-0"><h5 class="text-center">Edit Data <span class="font-weight-bold text-primary">Peserta</span></h5></div>
            <div class="card-body">
              ...
              <div class="form-group">
                ...
                <div class="form-group">
                  <select class="form-control" name="status">
                    ...
                    <option value="<?php echo $data['id_timeline'];?>"><?php echo $data['status'];?> : <?php echo $data['tanggal_mulai'];?> - <?php echo $data['tanggal_selesai'];?></option>
                    <?php }?>
                    <?php $timeline = mysqli_query($conn, "SELECT * FROM timeline ORDER BY tanggal_mulai ASC");?>
                    <?php while($data1 = mysqli_fetch_array($timeline)){?>
                    <option value="<?php echo $data1['id_timeline'];?>"><?php echo $data1['status'];?> : <?php echo $data1['tanggal_mulai'];?> - <?php echo $data1['tanggal_selesai'];?></option>
                    <?php } ?>
                </div>
